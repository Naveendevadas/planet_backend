...
export interface Config {
  ...
  collectionsSelect: {
    ...
    restaurant: RestaurantSelect<false> | RestaurantSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "restaurant_select".
 */
export interface RestaurantSelect<T extends boolean = true> {
  name?: T;
  description?: T;
  address?: T;
  city?: T;
